...
try{
 ...
 console.log('OK : 8 pages, 4 réalisations, 10 expériences interactives, 10 démos, 4 formations, 6 expériences/engagements, 24 articles, thèmes clair/sombre persistants, documents, filtres/recherche, navigation, modale, 4 tailles d’écran, interactions morpion/QCM/générateur/FAQ/notation.');
